        ...
        <div class="p-4 md:p-5">
          <form class="space-y-4" action="#">
            <div>
              ...
              <input type="product-name" name="product-name" id="product-name"
            ...
            <div>
              ...
              <input type="product-price" name="product-price" id="product-price"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
            ...
            <div>
              ...
              <input type="product-quantity" name="product-quantity" id="product-quantity"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
            ...
            <div>
              ...
              <input type="product-unit" name="product-unit" id="product-unit"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                placeholder="Nhập số lượng" required />
            </div>
